...
//                      alignment: Alignment.centerRight,
                ...
                Padding(
                    ...
                    child:
                        AllText("Search results", color: ColorRes.blackColor)),
                Padding(
              ...
              children: <Widget>[
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      new Container(
                        padding:
                            new EdgeInsets.only(left: 10, top: 8, right: 0),
                        child: Text(
                          'XYZ',
                          style: new TextStyle(
                              color: Colors.black,
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      new Container(
                        padding: new EdgeInsets.only(top: 8, right: 0, left: 5),
                        child: Text(
                          'XYZ',
                          style: new TextStyle(
                              color: Colors.black,
            ...
            children: <Widget>[
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    new Container(
                      padding: new EdgeInsets.only(left: 10, top: 8, right: 0),
                      child: Text(
                        'XYZ',
                        style: new TextStyle(
                            color: Colors.black,
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    new Container(
                      padding: new EdgeInsets.only(top: 8, right: 0, left: 6),
                      child: Text(
                        'XYZ',
                        style: new TextStyle(
                            color: Colors.black,
  ...
  tabs() {
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          new Padding(
            padding: new EdgeInsets.only(top: 8, right: 0),
            child: Text(
              'XYZ',
              style: new TextStyle(
                  color: Colors.black,
